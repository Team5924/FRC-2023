...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    mOperatorController.pov(180).and(mOperatorController.leftBumper().negate()).and(mOperatorController.rightBumper().negate()).onTrue(new ParallelCommandGroup(new SetPivot(mPivot, mOperatorController::getLeftY, PivotConstants.kSingleSubstation), new SetTelescope(mTelescope, mOperatorController::getLeftY, TelescopeConstants.kSingleSubstation)));

    // Pivot - Front + Cone

    mOperatorController.a().and(mOperatorController.leftBumper().negate()).and(mOperatorController.rightBumper()).onTrue(new ParallelCommandGroup(new SetPivot(mPivot, mOperatorController::getLeftY, PivotConstants.kGroundPickupCone), new SetTelescope(mTelescope, mOperatorController::getLeftY, TelescopeConstants.kGroundPickupCone)));
    mOperatorController.b().and(mOperatorController.leftBumper().negate()).and(mOperatorController.rightBumper()).onTrue(new ParallelCommandGroup(new SetPivot(mPivot, mOperatorController::getLeftY, PivotConstants.kMiddleGridCone), new SetTelescope(mTelescope, mOperatorController::getLeftY, TelescopeConstants.kMiddleGridCone)));
    mOperatorController.y().and(mOperatorController.leftBumper().negate()).and(mOperatorController.rightBumper()).onTrue(new ParallelCommandGroup(new SetPivot(mPivot, mOperatorController::getLeftY, PivotConstants.kTopGridCube), new SetTelescope(mTelescope, mOperatorController::getLeftY, TelescopeConstants.kTopGridCube)));
    mOperatorController.x().and(mOperatorController.leftBumper().negate()).and(mOperatorController.rightBumper()).onTrue(new ParallelCommandGroup(new SetPivot(mPivot, mOperatorController::getLeftY, PivotConstants.kHolding), new SetTelescope(mTelescope, mOperatorController::getLeftY, TelescopeConstants.kHolding)));

    mOperatorController.pov(0).and(mOperatorController.leftBumper().negate()).and(mOperatorController.rightBumper()).onTrue(new ParallelCommandGroup(new SetPivot(mPivot, mOperatorController::getLeftY, PivotConstants.kDoubleSubstation), new SetTelescope(mTelescope, mOperatorController::getLeftY, TelescopeConstants.kDoubleSubstation)));
    mOperatorController.pov(180).and(mOperatorController.leftBumper().negate()).and(mOperatorController.rightBumper()).onTrue(new ParallelCommandGroup(new SetPivot(mPivot, mOperatorController::getLeftY, PivotConstants.kSingleSubstation), new SetTelescope(mTelescope, mOperatorController::getLeftY, TelescopeConstants.kSingleSubstation)));
    ...
    mOperatorController.a().and(mOperatorController.leftBumper()).and(mOperatorController.rightBumper()).onTrue(new SetPivot(mPivot, mOperatorController::getLeftY, -PivotConstants.kGroundPickupCube));
    mOperatorController.a().and(mOperatorController.leftBumper()).and(mOperatorController.rightBumper()).onTrue(new ParallelCommandGroup(new SetPivot(mPivot, mOperatorController::getLeftY, -PivotConstants.kGroundPickupCone), new SetTelescope(mTelescope, mOperatorController::getLeftY, TelescopeConstants.kGroundPickupCone)));
    mOperatorController.b().and(mOperatorController.leftBumper()).and(mOperatorController.rightBumper()).onTrue(new ParallelCommandGroup(new SetPivot(mPivot, mOperatorController::getLeftY, -PivotConstants.kMiddleGridCone), new SetTelescope(mTelescope, mOperatorController::getLeftY, TelescopeConstants.kMiddleGridCone)));
    mOperatorController.y().and(mOperatorController.leftBumper()).and(mOperatorController.rightBumper()).onTrue(new ParallelCommandGroup(new SetPivot(mPivot, mOperatorController::getLeftY, -PivotConstants.kTopGridCube), new SetTelescope(mTelescope, mOperatorController::getLeftY, TelescopeConstants.kTopGridCube)));
    mOperatorController.x().and(mOperatorController.leftBumper()).and(mOperatorController.rightBumper()).onTrue(new ParallelCommandGroup(new SetPivot(mPivot, mOperatorController::getLeftY, -PivotConstants.kHolding), new SetTelescope(mTelescope, mOperatorController::getLeftY, TelescopeConstants.kHolding)));

    mOperatorController.pov(0).and(mOperatorController.leftBumper()).and(mOperatorController.rightBumper()).onTrue(new ParallelCommandGroup(new SetPivot(mPivot, mOperatorController::getLeftY, -PivotConstants.kDoubleSubstation), new SetTelescope(mTelescope, mOperatorController::getLeftY, TelescopeConstants.kDoubleSubstation)));
    mOperatorController.pov(180).and(mOperatorController.leftBumper()).and(mOperatorController.rightBumper()).onTrue(new ParallelCommandGroup(new SetPivot(mPivot, mOperatorController::getLeftY, -PivotConstants.kSingleSubstation), new SetTelescope(mTelescope, mOperatorController::getLeftY, TelescopeConstants.kSingleSubstation)));
  }
