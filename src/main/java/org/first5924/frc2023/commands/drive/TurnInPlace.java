...
public class TurnInPlace extends CommandBase {
  ...
  @Override
  public void execute() {
    mDrive.turnInPlace(JoystickToOutput.calculateSquared(mLeftJoystickY.getAsDouble(), 0.02), JoystickToOutput.calculateSquared(mRightJoystickX.getAsDouble(), 0.02));
  }
