...
public class CurvatureDrive extends CommandBase {
  ...
  @Override
  public void execute() {
    mDrive.curvatureDrive(JoystickToOutput.calculateSquared(mLeftJoystickY.getAsDouble(), 0.02), JoystickToOutput.calculateSquared(mRightJoystickX.getAsDouble(), 0.02));
  }
